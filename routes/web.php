...
Route::get('/goMyorder','Controller@goMyorder'); //INI CUSTOMER
Route::get('/goWishlist','Controller@goWishlist'); // INI CUSTOMER
...
Route::post('/saveTransaksi','CustCtr@saveTransaksi');
Route::post('/paypal','PaymentController@payWithpaypal');
Route::get('/cekBayar','PaymentController@getPaymentStatus');
Route::post('/ajukanPengembalian','CustCtr@ajukanPengembalian');
//admin
...
Route::post('/responPengembalian','SellerCtr@responPengembalian');